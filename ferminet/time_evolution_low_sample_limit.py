...
def make_td_opt_update_step_full_solve(
  ...
  def conduct_timestep(
    ...
    def invert_and_regularize_fisher(fisher):
      ...
      return SR_inv, eff_rank, s, jnp.where(s < ac, 0, s)
    ...
    SR_inv, eff_rank, eigs_old, eigs = invert_and_regularize_fisher(fisher)
    ...
    metrics = {
      ...
      "eigenvalues": eigs,
      "eigenvalues_unregularized": eigs_old
    }

    return theta_dot_real, metrics
